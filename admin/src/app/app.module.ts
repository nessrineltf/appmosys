...
import { ParaPharmaciesComponent } from './para-pharmacies/para-pharmacies.component';
...
@NgModule({
  declarations: [AppComponent, FullLayoutComponent, ContentLayoutComponent, ParaPharmaciesComponent],
  imports: [
